...
export class LocationController {
    ...
    static async createLocation(req, res, next) {
        try {
            ...
            if (!name)
                throw new AppError('Storage location name is required.', 400, 'MISSING_NAME');
...
export class DepartmentController {
    ...
    static async createDepartment(req, res, next) {
        try {
            ...
            if (!name)
                throw new AppError('Department name is required.', 400, 'MISSING_NAME');
...
export class AuditController {
    static async listAuditLogs(req, res, next) {
        try {
            ...
            const skip = page && limit ? (parseInt(page, 10) - 1) * take : 0;
