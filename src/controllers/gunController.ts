...
export class GunController {
  static async listGuns(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async getGun(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async createGun(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const {
        serialNumber,
        gunType,
  ...
  static async updateGun(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
  ...
  static async setMaintenance(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
  ...
  static async setUnavailable(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
