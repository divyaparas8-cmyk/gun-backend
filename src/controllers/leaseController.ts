...
export class LeaseController {
  static async listLeases(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async getLease(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async issueGun(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async returnGun(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async cancelLease(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
