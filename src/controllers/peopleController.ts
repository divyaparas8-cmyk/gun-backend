...
export class PeopleController {
  static async listPeople(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async getPerson(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
  ...
  static async createPerson(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const {
        fullName,
        fullNameAr,
  ...
  static async updatePerson(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
  ...
  static async blockPerson(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
  ...
  static async getGunHistory(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const id = String(req.params.id);
