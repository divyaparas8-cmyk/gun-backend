...
export class DashboardController {
  ...
  static async getRecentActivity(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      const formatted = logs.map((log) => {
        ...
        if (log.entityType === 'Gun') moduleName = 'Gun Register';
        else if (log.entityType === 'Person') moduleName = 'People';
        else if (log.entityType === 'Ammunition') moduleName = 'Ammunition';
        else if (log.entityType === 'Accessory') moduleName = 'Accessories';
        else if (log.entityType === 'Alert') moduleName = 'Alerts';
        else if (log.entityType === 'User' || log.entityType === 'Role') moduleName = 'Settings';
  ...
  static async getActionItems(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
